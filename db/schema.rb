...
ActiveRecord::Schema.define(version: 20161229051240) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index "lower((display_name)::text) text_pattern_ops", name: "users_display_name_lower", unique: true, using: :btree
